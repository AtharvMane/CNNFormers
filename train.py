...
if __name__=="__main__":
    ...
    ds = datasets.load_dataset("data/essence_of_imagenet_256")
    ...
    state_dict = load_file("./checkpoints_essence_of_imagenet_with_conv_unconv_former_tbs128/checkpoint-60000/model_new.safetensors")
